          ...
          <div class="card w-96 shadow-xl mt-12 ">
            <div class="card-body bg-base-300">
              ...
              <form class="form-control">
                <label class="block">
                  <input id="email" v-model="fields.email" type="email"
                    class="input input-sm w-full max-w-xs input-bordered" placeholder="Email" />
                </label>
                <label class="block mt-2">
                  <input id="password" v-model="fields.password" type="password"
...
const { auth, fields, Login } = useAuth();
