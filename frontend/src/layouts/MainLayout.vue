...
.form-tail:focus {
  @apply bg-gray-200 cursor-text;
}
.btn-primary-tail-rounded {
  @apply cursor-pointer text-white text-center font-semibold py-2 px-4 border  bg-blue-500  rounded-full mr-2;
}
