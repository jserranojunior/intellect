<template>
  <div class="flex ">
    <button class="mr-2 btn btn-sm" @click="changeMonth('-')">anterior</button>
    ...
    <button class="mx-2 btn btn-sm" @click="changeMonth('+')">próximo</button>
...
function changeMonth(operacao:string){
  ...
  let  newDate = dateJstoUs(alterarMeses(dateActual, operacao))
