...
Route::middleware('cors')->get('/v1/financeiro/{id}', 'Api\v1\Financial\ApiBillsToPay@edit');
Route::middleware('cors')->put('/v1/financeiro/{id}', 'Api\v1\Financial\ApiBillsToPay@update');
