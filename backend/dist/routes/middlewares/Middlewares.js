...
exports.default = {
    auth: function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var authHeader, deconstructionAuthHeader, scheme, token;
            return __generator(this, function (_a) {
                ...
                if (!authHeader) {
                    ...
                    deconstructionAuthHeader = authHeader.split(' ');
                    if (deconstructionAuthHeader.length !== 2) {
                        res.json(deconstructionAuthHeader);
                        res.status(401).send({ error: 'Token error' });
                    }
                    else {
                        scheme = deconstructionAuthHeader[0], token = deconstructionAuthHeader[1];
                        if (scheme !== "Bearer") {
